    ...
    blocks: [
      {
        ...
        textScale: "lg",
        nodusSpeech:
          "Сначала разберёмся с ИИ и данными. Потом Iris в Noda. Я рядом — торопиться не буду.",
...
Твоя задача — **не пропускать смысл**: если звучит как магия, найди, какие данные за этим спрятаны.`
      },
      {
        ...
        nodusSpeech: "Это главный зал. Дальше — оранжерея, там, где всё пошло по трещинам. Смотри внимательно, стажёр.",
      ...
      },
      {
        ...
        nodusSpeech: "Вижу эти «стёкла» над цветами? В Архиве это не декор. Это подписи — и они ломаются, как настоящее стекло.",
        caption: "Оранжерея: ирисы под панелями данных. Трещины — намёк, что разметка может быть хрупкой."
      },
      {
        id: "q00_story_lab",
        type: "text",
        nodusSpeech: "Здесь я учу не «красиво ответить», а воспроизвести цепочку улик. Каждая модель оставляет следы в данных — запомни.",
...
Оранжерея — другая зона, та же логика: без классов не понять, какой вид нужен для «противоядия» в истории про пыльцу.`
      },
      {
        id: "q00_problem",
        type: "text",
        nodusSpeech: "Я не предлагаю угадать цветок на глаз. Я предлагаю честную цепочку: данные → обучение → проверка → ответ, который можно проверить.",
...
**Стажер:** брифинг, затем в Noda — Iris и ответ, который можно **проверить**.`
...

      {
        id: "q01_gate_text",
        type: "text",
        nodusSpeech: "Вот распечатка: только числа, без фото. Сформулируй для себя — можно ли по ним понять живой объект?",
        body: `## Первая улика
...
От ответа зависит, зачем здесь таблица Iris и «пигмент» в деле про пыльцу.`
      },
      {
        id: "q00_hypothesis",
        type: "checkpoint",
        nodusSpeech: "Не гадай вслух — выбери гипотезу. Я потом покажу, где она бьётся о таблицу.",
...

      {
        ...
        type: "text",
        nodusSpeech: "ИИ уже рядом с тобой в сервисах. В нашем деле он просто должен честно отличать класс по цифрам.",
...
В нашем деле это **классификация вида цветка** по числам. Если ИИ держит шумные данные в других задачах — с ирисами тоже можно, при нормальной разметке и проверке.`
      },
      {
        id: "q01_ai_examples",
        type: "text",
        nodusSpeech: "Это моя «стена улик» из реальной жизни. Если здесь ИИ справляется — с ирисом шанс тоже есть.",
        body: `### Стена улик
...
Лицо и голос узнаёт — значит, и вид ириса по признакам не чудо.`
      },
      {
        id: "q01_ai_or_not",
        type: "checkpoint",
        nodusSpeech: "Таймер — не ИИ. Остальное ближе к тому, что мы делаем в Архиве.",
...

      {
        id: "q02_what_is_ai",
        type: "text",
        nodusSpeech: "Я называю ИИ программой, которая ищет повторяемость в примерах. Никакой мистики — только математика и данные.",
...
Не «думает как человек» — находит **математические связи**.`
      },
      {
        id: "q02_models_tasks",
        type: "text",
        nodusSpeech: "В нашем деле я забираю только одну строку из этой таблицы — классификацию. Остальное пригодится позже.",
...
В деле Ирисов — **классификация** (три вида).`
      },
      {
        id: "q02_model_types",
        type: "text",
        nodusSpeech: "Запомни цикл «данные → обучение → проверка → предсказание». Если цикл честный — модель можно защищать перед Архивом.",
...
Важно помнить цикл: **данные → обучение → проверка → предсказание**.`
      },
      {
        id: "q02_check",
        type: "checkpoint",
        nodusSpeech: "Один вопрос — как формулировать задачу. Ответь честно, без красивых слов.",
...

      {
        id: "q03_data_title",
        type: "text",
        nodusSpeech: "Без данных модель голодная. С плохими данными — она учится врать уверенно. Я это видел слишком часто.",
        body: `## Сцена 3. Данные
...
Форматы: изображения, звук, текст, таблицы чисел.`
      },
      {
        id: "q03_labels",
        type: "text",
        nodusSpeech: "Разметка — это мои «подписи на уликах». Испортишь подпись — испортишь вывод.",
        body: `### Разметка
...
Битая разметка — плохие уроки для модели.`
      },
      {
        id: "q03_data_check",
        type: "checkpoint",
        nodusSpeech: "Подумай, что я делаю с ошибочной уликой в папке дела…",
...

      {
        ...
        type: "text",
        textScale: "lg",
        nodusSpeech: "Три вида, один пигмент. Подписи пропали — остались числа. Знакомо? Это и есть наш кейс.",
...
Три вида: **setosa**, **versicolor**, **virginica**. Один — с нужным пигментом против пыльцы. Подписи у части цветов пропали, остались **только числа**.`
      },
      {
        ...
        nodusSpeech: "Я люблю, когда картинка совпадает с таблицей. Тогда мозг не сопротивляется цифрам.",
        caption: "Три вида на панели Архива: признаки и классы."
      },
      {
        id: "q04_table",
        type: "text",
        nodusSpeech: "Строка — цветок в день инцидента. Числа — то, что мы ещё видим. Вид — то, что нужно восстановить.",
        body: `### Таблица улик
...
Строка = пример; числа = **признаки**; вид = **метка**; задача = классификация.`
      },
      {
        ...
        type: "checkpoint",
        nodusSpeech: "Признак — что измерили. Метка — что нужно угадать.",
      ...
      },
      {
        ...
        type: "checkpoint",
        nodusSpeech: "Интуиция тоже улика. Но потом её проверяем числами.",
...

      {
        ...
        type: "text",
        nodusSpeech: "Я люблю, когда расследование превращается в конвейер. Так меньше шансов что-то забыть.",
...
1. Данные → 2. Разметка → 3. Train/test → 4. Обучение → 5. Проверка → 6. Новые примеры.`
      },
      {
        ...
        nodusSpeech: "Тест прячем в сейф до конца. Иначе я сам себе подставлю улики.",
        caption: "Часть примеров уходит в обучение, часть — в проверку. Так честнее оценить модель."
      },
      {
        id: "q05_split_text",
        type: "text",
        nodusSpeech: "Если ты подсмотрел контрольную — я не поверю твоей «точности». Так же и с моделью.",
        body: `### Train / test
...
Часто **80/20**. Если подмешать тест в обучение — модель может просто **запомнить ответы**.`
      },
      {
        id: "q05_split_check",
        type: "checkpoint",
        nodusSpeech: "Ответь как детектив: что ломается, если жульничать с контрольной?",
...

      {
        ...
        type: "text",
        nodusSpeech: "Я не верю глазам модели. Я верю метрикам на честной выборке.",
...
Уверенный ответ ≠ правильный. Метрики — чтобы не верить модели на слово.`
      },
      {
        id: "q06_metrics_text",
        type: "text",
        nodusSpeech: "Loss падает — учимся. Accuracy на тесте — это мой вердикт по делу.",
        body: `### Показатели
...
Смотри на **test accuracy** и динамику **loss**, а не на один красивый процент уверенности.`
      },
      {
        id: "q06_trust_check",
        type: "checkpoint",
        nodusSpeech: "Уверенность без проверки — как пустой пистолет в спектакле: громко, но бесполезно.",
      ...
      },
      {
        id: "q06_loss_check",
        type: "checkpoint",
        nodusSpeech: "Loss — не «красота графика». Это величина ошибки.",
...

      {
        id: "q07_fit_title",
        type: "text",
        nodusSpeech: "Две ловушки: не понял закономерность или заучил шум. Я по метрикам сразу вижу, где мы.",
...
**Недообучение** — слишком просто, закономерности не ухватил. **Переобучение** — заучил train, на новых провал.`
      },
      {
        ...
        nodusSpeech: "Смотри на три кривые как на показания свидетелей: кто врёт, кто честен, кто переигрывает.",
        caption: "Схема: недообучение, нормальный баланс и переобучение — по тому, как ведут себя ошибка на train и на новых данных."
      },
      {
        id: "q07_fit_text",
        type: "text",
        nodusSpeech: "Школьная аналогия работает. Главное — не красивые слова, а пара чисел train/test.",
        body: `### Аналогия
...
**Диагноз:** train низкий, test низкий → недообучение; train высокий, test низкий → переобучение.`
      },
      {
        id: "q07_fit_check",
        type: "checkpoint",
        nodusSpeech: "Классический почерк преступника: отлично на учебнике, провал на контрольной.",
...

      {
        id: "q08_noda_title",
        type: "text",
        nodusSpeech: "В Noda я собираю логику как детективную доску: блок за блоком, без простыни кода.",
        body: `## Сцена 8. Noda
...
Инструменты стажера — **блоки**: логику собирают цепочкой, без кода с нуля.`
      },
      {
        ...
        nodusSpeech: "Это палитра Архива. Не обязательно использовать всё — но каждый блок я знаю наизусть.",
        caption: "Палитра блоков Noda: события, данные, обучение, предсказание и вывод."
      },
      {
        id: "q08_blocks_text",
        type: "text",
        nodusSpeech: "Ниже — что делает каждый блок в цепочке. Если забудешь, вернись сюда как к шпаргалке следователя.",
...
Минимальная цепочка для нашего дела: **Старт → датасет Iris → обучить модель → предсказать → уверенность/класс → показать результат**.`
      },
      {
        id: "q08_blocks_check",
        type: "checkpoint",
        nodusSpeech: "Простой вопрос: где в цепочке мы «кормим» модель примерами?",
...

      {
        ...
        type: "text",
        textScale: "lg",
        nodusSpeech: "Теперь твои руки. Я открою студию — собери цепочку и покажи Архиву, что ты понял дело.",
...
Допуск к студии: собери цепочку **Iris → обучение → предсказание** и проверь, держит ли модель смысл.`
      },
      {
        ...
        kind: "image",
        url: "/api/coach/iris-quest-hero.png",
        nodusSpeech: "Мы возвращаемся в зал — симметрия дела: начали здесь, к студии тоже выходим отсюда.",
        caption: "Зал Архива перед запуском студии: тот же узел, откуда заводили расследование."
      },
      {
        id: "q09_studio",
        type: "studio",
        nodusSpeech: "Если уверенность красивая, а смысл пустой — скажи себе правду вслух. Я услышу.",
        instruction:
...

      {
        id: "q10_final_title",
        type: "text",
        nodusSpeech: "Я закрываю папку «Ирисовый шифр». Ты прошёл цепочку — это главная награда Архива.",
...
**Дело 002** — уже про картинки, не таблицы.`
      },
      {
        ...
        nodusSpeech: "Вернёмся к столу: ирисы, колбы, цифры. Так я запоминаю дела — не тостами, а тишиной после хорошей проверки.",
        caption: "Лабораторный стол Архива после дела: образцы и реагенты рядом — как финальный кадр расследования, когда шум стих."
      },
      {
        id: "q10_final_hook",
        type: "text",
        nodusSpeech: "Следующая папка уже пахнет пикселями, не CSV. Я подготовлю тебе вход.",
...
**Дело 002: изображения** — модель учится по картинкам, не по столбцам таблицы.`
      },
      {
        id: "q10_final_check",
        type: "checkpoint",
        nodusSpeech: "Последняя улика — на память: что проверить перед тем, как поверить модели?",
