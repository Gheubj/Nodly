    ...
    blocks: [
      {
        ...
        type: "text",
        textScale: "lg",
        body: `# Дело Хранителя: Архив ИИ

Ты — агент Академии Нода.  
Хранитель историй ИИ просит тебя открыть 3 печати:
- **Печать данных**
- **Печать обучения**
- **Печать проверки**

Цель урока: за 60 минут понять ИИ с нуля и собрать свою мини-модель в Noda.`
      },
      {
        id: "q_intro_2",
        type: "media",
        ...
        caption: "Хранитель: сегодня ты не смотришь презентацию — ты проходишь миссию."
      },
      {
        id: "q_intro_check",
        type: "checkpoint",
        question: "Как лучше описать ИИ?",
        answerMode: "single",
        options: ["Магия", "Программа, которая учится на данных", "Готовый список ответов"],
        expectedAnswer: "Программа, которая учится на данных"
      },
      { id: "q_div_1", type: "divider" },
      {
        id: "q_world_1",
        type: "text",
        body: `## Миссия 1. Где ИИ живет в реальной жизни

### YouTube / TikTok / Netflix
- система смотрит, что ты досматриваешь;
- что лайкаешь;
- что быстро пролистываешь.

ИИ находит людей с похожими предпочтениями и предлагает то, что зашло им.`
      },
      {
        id: "q_world_2",
        type: "text",
        body: `### Камеры, фильтры, распознавание лиц
- ИИ находит ключевые точки лица;
- «приклеивает» маску в реальном времени;
- тот же подход применяется в Face ID и безопасности.`
      },
      {
        id: "q_world_3",
        type: "text",
        body: `### Голосовые помощники
Цепочка:
1. слышит звук;
2. распознает слова;
3. определяет намерение;
4. формирует ответ.

Модели обучают на огромном количестве голосов, скоростей речи и акцентов.`
      },
      {
        id: "q_world_4",
        type: "text",
        body: `### ИИ в играх
- противники реагируют на игрока;
- мир адаптируется под уровень;
- иногда уровни генерируются автоматически.

Итог: ИИ уже рядом — это не «будущее», это «сейчас».`
      },
      {
        id: "q_world_check",
        type: "checkpoint",
        question: "Главный вывод миссии 1:",
        answerMode: "single",
        options: [
          "ИИ нужен только ученым",
          "ИИ уже встроен в повседневные сервисы и игры",
          "ИИ работает только без интернета"
        ],
        expectedAnswer: "ИИ уже встроен в повседневные сервисы и игры"
      },
      { id: "q_div_2", type: "divider" },
      {
        id: "q_data_1",
        type: "text",
        body: `## Миссия 2. Печать данных

ИИ учится как ученик: на примерах.

### Аналогия
Если тебе показать много фото «собака/кошка», ты начнешь замечать признаки.
ИИ делает то же самое, только математикой и на большем объеме.`
      },
      {
        id: "q_data_2",
        type: "text",
        body: `### Что такое данные
Данные — «еда» для ИИ:
- изображения;
- текст;
- звук;
...
Без данных модель не может учиться.`
      },
      {
        id: "q_data_3",
        type: "text",
        body: `### Почему важна разметка
Разметка — это подписи к примерам (класс/ответ).

Без меток модель не понимает, чему именно учиться.
Качество разметки напрямую влияет на качество предсказаний.`
      },
      {
        id: "q_data_4",
        type: "media",
        kind: "image",
        url: "/api/coach/idle.png",
        caption: "Хранитель: хорошие данные важнее «волшебной кнопки»."
      },
      {
        id: "q_data_5",
        type: "text",
        body: `### Ключевые факты
- каждый день создается гигантский объем данных (квинтиллионы байт);
- для учебных задач часто ориентиры такие:
  - минимум: ~1 000 примеров,
  - хорошо: ~10 000,
  - отлично: 100 000+;
- в больших датасетах разметку делают люди командами.`
      },
      {
        id: "q_data_check",
        type: "checkpoint",
        question: "Что критично для обучения модели?",
        answerMode: "multi",
        options: ["Качественная разметка", "Сбалансированные классы", "Случайные подписи", "Достаточный объем"],
        expectedAnswer: "Качественная разметка||Сбалансированные классы||Достаточный объем"
      },
      { id: "q_div_3", type: "divider" },
      {
        id: "q_train_1",
        type: "text",
        body: `## Миссия 3. Как ИИ учится шаг за шагом
...
4. Обучение  
5. Проверка  
6. Использование в реальной задаче`
      },
      {
        id: "q_train_2",
        type: "text",
...
Обычно стартовый принцип: 80/20.
Если модель видела тест заранее, оценка качества будет нечестной.`
      },
      {
        id: "q_train_3",
        type: "text",
        body: `### Закономерности — сердце ИИ
Примеры:
- Iris (цветы): по длине/ширине лепестка можно предсказать вид;
- цифры: модель ищет паттерн пикселей;
- школьные данные: можно предсказывать результат по признакам подготовки.

ИИ не «понимает» как человек — он ищет статистические связи.`
      },
      {
        id: "q_train_4",
        type: "text",
        body: `### Метрики и ошибки
- **Accuracy (точность)**: доля правильных ответов;
- **Loss (потери)**: насколько модель ошибается;
- цель обучения: уменьшать Loss и повышать качество на тесте.`
      },
      {
        id: "q_train_check",
        type: "checkpoint",
        question: "Что показывает метрика Loss?",
        answerMode: "single",
        options: ["Размер датасета", "Время запуска", "Величину ошибки модели"],
        expectedAnswer: "Величину ошибки модели"
      },
      { id: "q_div_4", type: "divider" },
      {
        id: "q_fit_1",
        type: "text",
        body: `## Миссия 4. Опасности обучения: underfitting / overfitting

### Недообучение (underfitting)
Модель слишком простая и не ловит закономерности.

### Переобучение (overfitting)
Модель запомнила тренировку, но на новых данных ошибается.`
      },
      {
        id: "q_fit_2",
        type: "text",
        body: `### Как заметить
- train-качество высокое, test-качество низкое -> признак переобучения;
- и train, и test низкие -> признак недообучения.`
      },
      {
        id: "q_fit_3",
        type: "text",
        body: `### Что делать
- больше и чище данных;
- баланс классов;
- корректная сложность модели;
- не «перетренировывать» бесконечно;
- проверять на новых примерах, а не только на train.`
      },
      {
        id: "q_fit_check",
        type: "checkpoint",
        question: "Ситуация: train=99%, test=60%. Что вероятнее всего?",
        answerMode: "single",
        options: ["Недообучение", "Переобучение", "Все отлично"],
      ...
      { id: "q_div_5", type: "divider" },
      {
        id: "q_noda_1",
        type: "text",
        body: `## Миссия 5. Платформа Noda — твоя лаборатория

### Режимы
- начальный: визуальные блоки и подсказки;
- продвинутый: больше контроля и свои проекты.

Сегодня: начальный режим + практическая миссия.`
      },
      {
        id: "q_noda_2",
        type: "text",
...
- **События**: старт;
- **Данные**: число/текст;
- **Модель и обучение**: обучить модель;
- **Предсказание**: предсказать, класс, уверенность;
- **Управление**: если/то, логика, ожидание;
- **Действия**: показать сообщение/результат, журнал.`
      },
      {
        id: "q_noda_3",
        type: "text",
...
- строка = один пример;
- столбцы = признаки и метка.

Можно:
1) загрузить файл (когда примеров много);
2) ввести вручную (быстрые тесты).`
      },
      {
        id: "q_noda_4",
        type: "text",
        body: `### Цели, помощник и сохранения
- в мини-разработке есть цели (чеклист прогресса);
- персонаж подсказывает, что делать дальше;
- проект можно сохранить и вернуться позже.`
      },
      { id: "q_div_6", type: "divider" },
      {
        ...
        type: "text",
        textScale: "lg",
        body: `## Финальная миссия: мини-лаборатория ИИ

Собери полноценный цикл:
**датасет -> обучение -> предсказание -> анализ ошибки**.`
      },
      {
        id: "q_lab_studio",
        type: "studio",
        instruction:
          "Открой mini-лабораторию. Выбери image-датасет, добавь блок обучения, запусти train и сделай prediction. После этого оцените, уверена ли модель и где может ошибаться.",
        studioPracticeKind: "empty",
        studioWorkspaceLevel: 1,
        goals: [
          { id: "q_goal_1", title: "Выбери image-датасет", type: "select_dataset", datasetKind: "image" },
          { id: "q_goal_2", title: "Добавь блок «Обучить модель»", type: "add_block", blockType: "noda_train_model_simple" },
          { id: "q_goal_3", title: "Запусти обучение", type: "train_model" },
          { id: "q_goal_4", title: "Сделай предсказание", type: "run_prediction" }
        ]
      },
      {
        id: "q_final_reflect",
        type: "checkpoint",
        question:
          "Коротко: почему модель с хорошим train-результатом может ошибаться на новых данных и как это исправлять?",
        answerMode: "text",
        expectedAnswer:
          "Из-за переобучения и/или плохих данных. Нужно улучшать качество и баланс данных, проверять на тестовой выборке и корректировать обучение."
      },
      {
        id: "q_final_1",
        type: "text",
        body: `## Миссия завершена
Ты прошел путь настоящего разработчика ИИ:
- понял, как ИИ учится;
- разобрался с Loss и качеством;
- увидел underfitting/overfitting;
- собрал рабочую мини-модель в Noda.

Хранитель открывает следующую главу.`
      },
      {
        id: "q_final_2",
        type: "media",
        kind: "image",
        url: "/api/coach/success.png",
        caption: "Хранитель: теперь ты не наблюдатель, ты создатель."
      }
    ],
    presentationPdfUrl: null,
    slides: [],
